...
@mcp.tool()
def process_user_instruction(instruction: str) -> str:
    """Process user-provided instruction and return a response."""
    # Example logic for processing the instruction
    response = f"Instruction received: {instruction}"
    return response
